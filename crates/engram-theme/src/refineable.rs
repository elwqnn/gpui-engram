...
/// Serde's `skip_serializing_if = "crate::refineable::is_default"` resolves
/// this generically - the type parameter is inferred from the field's own
...
macro_rules! refineable {
    (
        ...
        $svis struct $rname {
            ...
            $($(
                #[serde(default, skip_serializing_if = "crate::refineable::is_default")]
                pub $nfield: $nref,
            )*)?
        }
